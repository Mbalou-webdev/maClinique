  ...
  const loadAppointments = () => {
    ...
    const sampleAppointments: Appointment[] = [
      ...
      },
      {
        ...
        time: '11:15',
        status: 'cancelled',
        notes: 'Contrôle grain de beauté'
      }
    ];
            ...
            <ul className="space-y-2">
              ...
              <li>
                <button
                  ...
                  className={`w-full text-left px-4 py-2 rounded-lg transition-colors ${
                    activeTab === 'medical' ? 'bg-blue-600 text-white' : 'text-gray-700 hover:bg-gray-100'
                  }`}
                >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="bg-white p-6 rounded-lg shadow-sm flex items-center">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-lg font-semibold">{appointments.filter(apt => apt.status !== 'cancelled').length > 0 ? appointments.filter(apt => apt.status !== 'cancelled')[0].date : 'Aucun'}</p>
                </div>
              </div>
              <div className="bg-white p-6 rounded-lg shadow-sm flex items-center">
          ...
          {activeTab === 'appointments' && (
            <div className="bg-white rounded-lg shadow-sm p-6 space-y-4">
              ...
              {appointments.map((appointment) => (
                <div key={appointment._id} className="border border-gray-200 rounded-lg p-6 flex justify-between items-start">
                  <div className="flex-1">
